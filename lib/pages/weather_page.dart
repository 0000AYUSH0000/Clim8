import 'package:clim8/models/weather_model.dart';
import 'package:clim8/pages/detail_weather_page.dart';
import 'package:clim8/pages/search.dart';
import 'package:clim8/services/weather_service.dart';
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => WeatherForecastPage(cityName:_weather!.cityName,),
                  ),
                );
              },
              child: Text(
