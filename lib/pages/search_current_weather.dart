...
class SearchCurrentWeather extends StatelessWidget {
  ...
  const SearchCurrentWeather({Key? key, required this.cityWeather}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              Text(
                ...
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white,fontFamily: 'RedditMono'),
              ),
              SizedBox(height: 10),
              Image.asset(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontSize: 18, color: Colors.white,fontFamily: 'RedditMono'),
                    ),
                    const SizedBox(
                      height: 15,
                    ),
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => WeatherForecastPage(cityName:cityWeather['name']),
                    ),
                  );
                },
                child: Text(
